...
FNAME_SORTED_LIST_NAIVE  = './data/sorted_list_naive_PartialBias_hijack_{}.json'
FNAME_SORTED_LIST_GREEDY = './data/sorted_list_greedy_PartialBias_hijack_{}.json'
FNAME_SORTED_BIAS_NAIVE  = './data/sorted_bias_naive_PartialBias_hijack_{}.csv'
FNAME_SORTED_BIAS_GREEDY = './data/sorted_bias_greedy_PartialBias_hijack_{}.csv'

# select features for visualization
# FEATURE_NAMES_DICT = bu.get_features_dict_for_visualizations() 
# FEATURES = list(FEATURE_NAMES_DICT.keys())
FEATURES = ['AS_rank_source', 'AS_rank_iso', 'AS_rank_continent', 
	'AS_rank_total', 'AS_rank_peer', 'AS_rank_customer', 'AS_rank_provider', 
	'peeringDB_ix_count', 'peeringDB_fac_count']
...
for k in ['RC']:
	...
	a = bu.subsampling('sorting', df, set_of_monitors, params, FEATURES)
	with open(FNAME_SORTED_LIST_NAIVE.format(k),'w') as f:
		json.dump(a,f)

	print('\t Greedy algorithm ...')
	b = bu.subsampling('greedy', df, set_of_monitors, params, FEATURES)
