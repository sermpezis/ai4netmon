...
FNAME_SORTED_LIST_NAIVE  = './data/sorted_list_naive_hijack_{}.json'
FNAME_SORTED_LIST_GREEDY = './data/sorted_list_greedy_hijack_{}.json'
FNAME_SORTED_BIAS_NAIVE  = './data/sorted_bias_naive_hijack_{}.csv'
FNAME_SORTED_BIAS_GREEDY = './data/sorted_bias_greedy_hijack_{}.csv'
