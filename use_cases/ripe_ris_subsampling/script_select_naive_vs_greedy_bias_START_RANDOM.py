...
## datasets
STEP = 20
FNAME_SORTED_LIST_NAIVE  = './data/sorted_list_naive_rnd301_{}.json'
FNAME_SORTED_LIST_GREEDY = './data/sorted_list_greedy_rnd301_{}.json'
FNAME_SORTED_BIAS_NAIVE  = './data/sorted_bias_naive_rnd301_{}.csv'
FNAME_SORTED_BIAS_GREEDY = './data/sorted_bias_greedy_rnd301_{}.csv'
...
for k in ['Atlas']:#set_infra.keys(): 
	...
	set_of_monitors = set(random.sample(list(set_infra[k].index),300))
