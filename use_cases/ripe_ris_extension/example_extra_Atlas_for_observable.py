...
BIAS_DF = './data/bias_df__no_stubs_Atlas.csv'
BIAS_DF_GROUPS = './data/bias_df__no_stubs_Atlas_groups.{}'
...
only_columns = ['AS_rank_source', 'AS_rank_numberAsns', 'AS_rank_numberPrefixes', 'AS_rank_iso', 'AS_rank_total', 
	...
	'is_in_peeringDB', 'is_ris_peer_v4', 'is_ris_peer_v6', 'is_routeviews_peer']
df = df[only_columns] 
...
bias_diff = (bias_df/bias_df.loc['Atlas',:]-1)*100
...
new_bias_diff.drop('Atlas',inplace=True)
