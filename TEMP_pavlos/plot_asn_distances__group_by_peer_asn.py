...
ASN2ASN_DIST_FNAME = './data/asn2asn__only_peers.json'
FIG_IMSHOW_FNAME = './figures/fig_imshow_asn_visibility_min_dist_group_by_peer_asn_IPv4.png'
FIG_ECDF_FNAME = './figures/fig_ecdf_asn_visibility_group_by_peer_asn_IPv4.png'
...
plt.ylabel('Visibility (by #peer_asns)', fontsize=fontsize_large)
...
plt.xlabel('Visibility (by #peer_asns)', fontsize=fontsize_large)
plt.ylabel('CDF', fontsize=fontsize_large)
plt.title('Distribution of ASN visibility (by #peer_asns)', fontsize=fontsize_large)
plt.grid()
